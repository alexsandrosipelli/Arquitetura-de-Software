...
public class Singleton {/*lazy singleton carrega a classe mas apenas é instanciada quando é chamada o padrao lazy singleton  nao garate uma intancia apenas*/
    /*o outro singleton, dele é  ja instanciando assim que executa a classe. se fizer varias threads vai ser a mesma instancia sempre*/
    ...
    private static Singleton singleton ;     /*variavel estatica da classe Singleton nao é um obj, pq nao tem new alguma coisa kkkkk */
